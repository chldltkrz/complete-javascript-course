...
const printGoals = function (...names) {
  console.log(`${names.length} goals were taken`);
};

printGoals('D', 'M', 'L', 'K');
printGoals('D', 'M', 'L', 'K', 'P');
...
*/
//1
for (const [num, val] of game.scored.entries()) {
  console.log(`Goal ${num + 1}: ${val}`);
}
...
console.log(aver / Object.values(game.odds).length);
...
for (const [team, odds] of Object.entries(game.odds)) {
  if (team === 'x') {
    ...
    console.log(`Odd of victory ${game[team]} : ${odds}`);
  }
}
// BONUS: Create an object called 'scorers' which contains the names of the players who scored as properties, and the number of goals as the value. In this game, it will look like this:
//       {
